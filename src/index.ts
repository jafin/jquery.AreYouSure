 ...
 * Version: 1.9.1
 * Patched for performance PR 139 from Original repo
 * replace deprecated bind with on events.
 * Date:    10/02/2023
 */
...
$.fn.areYouSure = function (options:any) {
  var settings = $.extend(
    {
  ...
  var getValue = function ($field: any) {
    if (
  ...
  var storeOrigValue = function ($field: any) {
    $field.data("ays-orig", getValue($field));
  };

  var isFieldDirty = function ($field: any) {
  ...
  var checkForm = (evt: any): void => {
    ...
    var isDirty = false;
    $fields.each(function (): false | void {
      let $field = $(this);
  ...
  var initForm = function ($form: any) {
  ...
  var setDirtyStatus = function ($form: any, isDirty: boolean) {
  ...
  return this.each(function() {
    ...
    // Add a custom events
    $form.on("getDirtyFields.areYouSure", getDirtyFields);
